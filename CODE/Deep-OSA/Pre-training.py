...
parser = argparse.ArgumentParser(description="LeNet-OSA")
parser.add_argument("--dataset_dir", default= "/content/drive/MyDrive/apnea-ecg-database-1.0.0", type=str, help="dataset dir")
global opt, model
